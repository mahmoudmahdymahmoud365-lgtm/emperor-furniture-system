  ...
  return (
    <AppLayout>
      <div className="space-y-6 animate-fade-in">
        ...
        <ExportButtons data={employees as any} headers={[{ key: "id", label: "الكود" },{ key: "name", label: "الاسم" },{ key: "nationalId", label: "الرقم القومي" },{ key: "phone", label: "الهاتف" },{ key: "branch", label: "الفرع" },{ key: "monthlySalary", label: "المرتب الشهري" },{ key: "role", label: "الدور" }]} fileName="الموظفين" title="قائمة الموظفين" />
